...
p       <- ggplot(d, aes( x = gene, y = PG_FuFs, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           ...
           scale_color_manual(name = 'ST131', values = setNames(c("#F94144", 'black'), c(T,F)))

title <- paste("PG_FuFs_R: ", SUMMARY.PREFIX, sep = "")
p       <- ggplot(d, aes( x = gene, y = PG_FuFs_R, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
title <- paste("PG_TajimaD: ", SUMMARY.PREFIX, sep = "")
p       <- ggplot(d, aes( x = gene, y = PG_TajimaD, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
title <- paste("PG_TajimaD_R: ", SUMMARY.PREFIX, sep = "")
p       <- ggplot(d, aes( x = gene, y = PG_TajimaD_R, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
p       <- ggplot(d, aes( x = gene, y = PG_FuliF, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
title <- paste("PG_FuliF_R: ", SUMMARY.PREFIX, sep = "")
p       <- ggplot(d, aes( x = gene, y = PG_FuliF_R, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
p       <- ggplot(d, aes( x = gene, y = PG_FuliD, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
title <- paste("PG_FuliD_R: ", SUMMARY.PREFIX, sep = "")
p       <- ggplot(d, aes( x = gene, y = PG_FuliD_R, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
p       <- ggplot(d, aes( x = gene, y = PG_pi, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
title <- paste("PG_pi_R: ", SUMMARY.PREFIX, sep = "")
p       <- ggplot(d, aes( x = gene, y = PG_pi_R, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
title <- paste("FS/length: ", SUMMARY.PREFIX, sep = "")
p       <- ggplot(d, aes( x = gene, y = ntFS/aln_length, colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
title <- paste("NS/length: ", SUMMARY.PREFIX, sep = "")
p       <- ggplot(d, aes( x = gene, y = aaNS/(aln_length/3), colour = dataset == '131')) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
title <- paste("haps/nSeq: ", SUMMARY.PREFIX, sep = "")
p       <- ggplot(d, aes( x = gene, y = PG_Haplo_R/PG_nSeqs_R), colour = dataset == '131') +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
...
#######################################################################
title <- paste("PG_FuFs: ", SUMMARY.PREFIX, sep = "")
FuFs <- ggplot(d, aes( x = gene, y = PG_FuFs)) +
           theme_light()+
           theme(text=element_text(size=8), axis.text.x=element_text(angle=45))+
           ggtitle(title) +
           geom_point(aes(shape = gene)) +
